...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <section class="header">
            ...
            <div class="text-box">
                <h1>List Siswa<br>XI MIPA 5</h1>
                <p>daftar siswa yang ada di XI MIPA 5.</p>
            </div>
        </section>
        <section class="list min-vh-100" id="list">
            <div class="container-fluid">
                <h2 class="my-5 text-center fw-bold">LIST SISWA</h2>
